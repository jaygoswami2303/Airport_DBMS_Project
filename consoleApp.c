...
201501410
201501450
Domestic Airport and airlines database
*/
...
void ExecuteQuery(PGconn* conn,char* query){
    PQexec(conn, "set search_path to airport;");
...
int main()
{
  const char *conninfo = "dbname=201501450 user=201501450 password=201501450 hostaddr=10.100.71.21 port=5432";
